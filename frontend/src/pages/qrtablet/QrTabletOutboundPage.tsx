...
export default function QrTabletOutboundPage() {
  ...
  const columns: ColumnsType<OutboundOrder> = [
    {
      ...
      render: (text: string, record: OutboundOrder) => (
        <a
          ...
          onClick={() => navigate(`/qrtablet/export/${record.id}`)}
        >
          {text}
        </a>
      ),
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <Card>
        <div className="mb-6 flex flex-col items-stretch justify-between gap-4 lg:flex-row lg:items-center">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Input
              ...
              className="w-full shrink-0 !h-11 sm:w-[280px]"
              style={{
        ...
        <Table
          ...
          scroll={{ x: 720 }}
          onRow={(record) => ({
            onDoubleClick: () => navigate(`/qrtablet/export/${record.id}`),
          })}
