...
const tableClassName =
    '[&_.ant-table-thead_th]:!bg-stripe-canvas-soft [&_.ant-table-thead_th]:!text-brand-dark [&_.ant-table-thead_th]:!font-semibold [&_.ant-table-thead_th]:!text-sm [&_.ant-table-row]:hover:!bg-brand-primary/5 [&_.ant-table-cell]:!text-center'
